...
<body>
	<div>
		<label style="font-weight: bold; font-size: 30px">請輸入Email取得變更資料
		</label> <input placeholder="Email" type="text" name="queryVal"
			id="updateAjax" required>
		<button id="loadbutton">load</button>
		<span id="spupdateAjax"></span><br>
	</div>
		...
		<main class="page-content">
			<div class="container">
				...
				<div class="zi_box_1">
					<form class="container" action="updatemember.controller"
						...
						<div class="col-md-12">
							<div class="input-group mb-3">
								<span class="input-group-text" id="inputGroup-sizing-default">修改密碼:</span>
								<input type="text" class="form-control"
									aria-label="Sizing example input"
						...
						<div class="col-md-12">
							<div class="input-group mb-3">
								<span class="input-group-text" id="inputGroup-sizing-default">修改姓名:</span>
								<input type="text" class="form-control"
									aria-label="Sizing example input"
						...
						<div class="col-md-12">
							<div class="input-group mb-3">
								<span class="input-group-text" id="inputGroup-sizing-default">修改電話:</span>
								<input type="text" class="form-control"
									aria-label="Sizing example input"
						...
						<div class="col-md-12">
							<div class="input-group mb-3">
								<span class="input-group-text" id="inputGroup-sizing-default">修改生日:</span>
						...
						<div class="col-md-12">
							<div class="input-group mb-3">
								<span class="input-group-text" id="inputGroup-sizing-default">修改地址:</span>
								<input type="text" class="form-control"
									aria-label="Sizing example input"
						...
						<div class="col-12">
							<button type="submit" value="Add" class="btn btn-primary">確認修改</button>
						</div>
					</form>
				</div>
			</div>
			...
			<script>
				$('#loadbutton').click(function() {
					...
					var queryVal = $('#updateAjax').val();

					$.ajax({
						type : 'POST',
						url : 'getByA_idAjax.controller',
						data : {
							"queryVal" : queryVal
						},
						dataType : 'json',
						success : function(data) {
							$('#a_id').val(data.aid);
							$('#a_password').val(data.apassword);
							$('#a_name').val(data.aname);
							$('#a_phone').val(data.aphone);
							$('#a_birthday').val(data.abirthday);
							$('#a_address').val(data.aaddress);
					...
					$('#spupdateAjax').style.display = "none";
				});
			</script>
